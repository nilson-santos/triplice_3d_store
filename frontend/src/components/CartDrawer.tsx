...
export const CartDrawer = ({ isOpen, onClose }: CartDrawerProps) => {
    ...
    return (
        <>
            ...
            {/* Drawer */}
            <div className="fixed top-0 right-0 h-full w-full max-w-md bg-white z-40 shadow-2xl transform transition-transform duration-300">
            ...
            <CheckoutModal
                ...
                onClose={() => {
                    ...
                    onClose(); // Close drawer too if success? modal handles cleanup.
                }}
            />
        </>
    );
